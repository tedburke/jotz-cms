...
echo("<table>" . PHP_EOL);
echo("<tr> <th>User</th> <th>Articles</th> <th>File uploads</th> <th>Lines of text</th> <th>Word count</th> <th>Character count</th> <th>Disk usage [kB]</th> <th>Email address</th> </tr>" . PHP_EOL);

$csv = "User,Articles,File uploads,Lines of text,Word count,Character count,Disk usage,Email address" . PHP_EOL;

foreach ($users as $user)
{
  // user's email address
  $user_email = $user . "@mytudublin.ie";
  ...
  echo("<tr> <td><a href=\"../$user\">$user</a></td> <td>$article_count</td> <td>$upload_count</td> <td>$line_count</td> <td>$word_count</td> <td>$character_count</td> <td>$kB_count</td> <td><a href=\"mailto:$user_email\">$user_email</a></td> </tr>" . PHP_EOL);
  
  // Also add this user's stats to the CSV string
  $csv = $csv . "$user,$article_count,$upload_count,$line_count,$word_count,$character_count,$kB_count,$user_email" . PHP_EOL;
}
echo("</table>" . PHP_EOL);
